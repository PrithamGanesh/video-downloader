...
def Browse():
	...
	# initialdir argument is optional Retrieving the user-input destination directory and storing it in downloadDirectory
...
def Download():
	...
	Youtube_link = video_Link.get(mp4files[-1].extension, mp4files[-1].resolution)
